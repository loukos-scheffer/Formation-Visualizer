...
FormationVisualizer.prototype = {
    ...
    setTeam1matches: function (playerNumber, numMatches) {
        this.team1players[playerNumber].matches = numMatches
    },
    setTeam2matches: function (playerNumber, numMatches) {
        this.team2players[playerNumber].matches = numMatches
    },
    ...
    getTeam1matches: function (playerNumber) {
        return this.team1players[playerNumber].matches
    },
    getTeam2matches: function (playerNumber) {
        return this.team2players[playerNumber].matches
    },
    ...
    setTeam1PlayerStats: function (playerNumber, numGoals, numMatches, numGoalsAgainst, numShotsAgainst, numShots, numxGoalsAgainst, numxGoals, numRating, numSaves, numFoulsCommitted, numRedCards, numYellowCards) {
        this.team1players[playerNumber].goals = numGoals
        this.team1players[playerNumber].matches = numMatches
        this.team1players[playerNumber].shots = numShots
        this.team1players[playerNumber].saves = numSaves
    ...
    setTeam2PlayerStats: function (playerNumber, numGoals, numMatches, numGoalsAgainst, numShotsAgainst, numShots, numxGoalsAgainst, numxGoals, numRating, numSaves, numFoulsCommitted, numRedCards, numYellowCards) {
        this.team2players[playerNumber].goals = numGoals
        this.team2players[playerNumber].matches = numMatches
        this.team2players[playerNumber].shots = numShots
        this.team2players[playerNumber].saves = numSaves
